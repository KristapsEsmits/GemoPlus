...
<html lang="en">
    ...
    <body>
        ...
        <h1 class="subvirsraksts">Iegūsti jaunākos atjauninajumus un labāku pieredzi izmantojot kādu no mūsu aplikācijām!
        </h1>
        <div class="pc">
            <h2>Download for PC:</h2>
        </div>
        <a href="https://drive.google.com/uc?export=download&id=1tccWMVvatjucFSWpTJNhMvHCIap6cvYP" target="_blank"
